...
public class user_ui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEncontrarRutas = new javax.swing.JButton();
        ...
        btnEncontrarRutas.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        btnEncontrarRutas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/user/img/icons8-search-26.png"))); // NOI18N
        btnEncontrarRutas.setText("Encontrar rutas");
        btnEncontrarRutas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEncontrarRutasActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnEncontrarRutas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnEncontrarRutas, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void btnEncontrarRutasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncontrarRutasActionPerformed
        String origen = txtCodigoOrigen1.getText().trim().toUpperCase();
        String destino = txtCodigoDestino1.getText().trim().toUpperCase();

        if (origen.isEmpty() || destino.isEmpty()) {
            JOptionPane.showMessageDialog(this,
                    "Por favor ingrese el código de origen y destino.",
                    "Campos vacíos",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }

        String resultado = grafo.encontrarRutas(origen, destino);
        txtAeropuertosDisponibles.setText(resultado);
        limpiarCampos();
    }//GEN-LAST:event_btnEncontrarRutasActionPerformed
    ...
    private javax.swing.JButton btnEncontrarRutas;
